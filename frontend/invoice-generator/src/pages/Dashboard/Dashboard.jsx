...
/>
      ...
      {/* Recent Invoices */}
      <div className="w-full bg-white border border-slate-200 rounded-lg shadow-sm shadow-gray-100 divide-y overflow-hidden">
        <div className="px-4 sm:px-6 py-4 border-slate-200 bg-slate-50 flex justify-between items-center ">
  ...
  <td className="px-6 py-4 whitespace-nowrap text-sm text-slate-500">
    {moment(invoice.dueDate).format("MMM D, YYYY")}
            ...
            <div className="flex flex-col items-center justify-center py-12 text-center">
              <div className="w-16 h-16 bg-slate-100 rounded-full flex items-center justify-ecnter mb-4 ">
